...
def main():
    ...
    m1.load_state_dict(torch.load('best_shufflenet_ext.pth', map_location=DEVICE, weights_only=True))
    m2.load_state_dict(torch.load('best_weights_auto_mobilenet.pth', map_location=DEVICE, weights_only=True))

    m1 = train_single_model_sam(m1, train_loader, val_loader, "ShuffleNetV2", epochs=20)
    ...
    output_filename = 'my_model_sam_ensemble_2.pt'
