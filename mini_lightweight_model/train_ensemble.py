...
def train_one_epoch(model, loader, optimizer, criterion, scaler, cfg):
    ...
    for imgs, labels in loader:
        ...
        with torch.amp.autocast('cuda'):
            logits = model(logits = model(imgs)) if False else model(imgs)
...
def main():
    ...
    # Pre-build models to check total parameters upfront
    ...
    # Fail-fast check before any training or data loading
    ...
    # Clear check models from memory
